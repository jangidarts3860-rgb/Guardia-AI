      ...
      <div className="space-y-5">
        ...
        <motion.div initial={{ scale: 0.9, y: 20, opacity: 0 }} animate={{ scale: 1, opacity: 1 }}
          ...
          <div className="grid grid-cols-3 gap-2 text-center pt-2">
            <div><p className="text-lg font-black text-white font-mono">{subsCancelled}</p><p className="text-[9px] text-slate-500 leading-snug">Subscriptions cancelled</p></div>
            <div><p className="text-lg font-black text-white font-mono">{totalScamsBlocked}</p><p className="text-[9px] text-slate-500 leading-snug">Scams blocked</p></div>
            <div><p className="text-lg font-black text-white font-mono">{Math.max(subsCancelled, totalScamsBlocked, 8)}</p><p className="text-[9px] text-slate-500 leading-snug">Months protected</p></div>
          </div>
        ...
        <div className="p-4 bg-slate-900 border border-slate-800 rounded-2xl flex justify-between items-center">
          ...
          <button onClick={() => setIsAnonymized(!isAnonymized)} className={`w-11 h-6 rounded-full transition relative ${isAnonymized ? 'bg-sky-500' : 'bg-slate-800'}`} role="switch" aria-checked={isAnonymized} aria-label="Anonymize savings card">

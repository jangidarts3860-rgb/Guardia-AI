...
export default function PhoneSimulator({ children, isOffline, isLightMode, currentScreen = 'splash' }: PhoneSimulatorProps) {
  return (
    <div className="relative mx-auto flex items-center justify-center p-4">
      {/* Phone Frame wrapper */}
      <div id="phone-simulator-frame" className="relative w-[375px] h-[780px] rounded-[52px] border-[10px] border-slate-900 bg-slate-950 shadow-[0_25px_60px_-15px_rgba(0,0,0,0.8)] flex flex-col overflow-hidden ring-4 ring-slate-800/50">
        <div id="phone-viewport" className="w-full h-full flex flex-col relative bg-slate-950 overflow-hidden rounded-[42px]">

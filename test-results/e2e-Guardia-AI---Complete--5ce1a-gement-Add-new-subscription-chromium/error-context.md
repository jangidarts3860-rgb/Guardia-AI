...
- Name: e2e.spec.ts >> Guardia AI - Complete E2E Test Suite >> Subscription Management >> Add new subscription
- Location: tests\e2e.spec.ts:104:5
...
Locator: locator('[data-screen="subs-dashboard"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-screen="subs-dashboard"]')
...
- main:
  ...
  - heading "Track new spend" [level=2]
  - paragraph: Enter details manually to monitor renewal alerts and waste analysis.
  - text: Subscription Name
  - textbox "Subscription Name":
    - /placeholder: e.g. Netflix, Adobe Creative Cloud
    - text: Test Subscription
  - text: Cost (INR)
  - spinbutton "Cost (INR)": "999"
  - text: Billing Cycle
  - combobox "Billing Cycle":
    - option "Monthly" [selected]
    - option "Yearly"
  - button "Save Subscription"
  - button "Cancel"
  - log "Notifications":
    - text: Success Test Subscription subscription added!
    - button "Dismiss"
- button "Home"
- button "Subs"
- button
